...
else
{
	...
	if(isset($_POST['username'], $_POST['password']))
	{
		...
		$req = mysql_query('select password,id from users where username="'.$username.'" and dlt != 1');
...
<?php
		...
		{
			$form = false;
			$message = 'The username or password you entered are not good OR You are banned';
		}
	}
	else
	{
...
?>
		<div class="foot"><a href="index.php">homepage</a></div>
	</body>
</html>
